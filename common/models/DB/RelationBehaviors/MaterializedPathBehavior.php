...
namespace common\models\DB\RelationBehaviors;
 ...
 */
use common\models\DB\RelationBehaviors\SortableBehavior;
use Yii;
...
class MaterializedPathBehavior extends Behavior
{
	 ...
	 * @var string
	 */
	public $pathAttribute = 'm_path';
	/**
	 * @var string
	 */
	public $depthAttribute = 'm_path_depth';
	/**
	 * @var string
	 */
